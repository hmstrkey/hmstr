...
const maps = {
    '2024-07-21': {
        blocks: [
            {id: 1, x: 0, y: 1, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 2, x: 1, y: 0, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 3, x: 0, y: 3, width: 2, height: 1, direction: 'horizontal', color: 'green'},
            {id: 4, x: 0, y: 4, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 5, x: 1, y: 5, width: 2, height: 1, direction: 'horizontal', color: 'green'},
            {id: 6, x: 3, y: 0, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 7, x: 4, y: 1, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 8, x: 5, y: 4, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 9, x: 2, y: 3, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
    ...
    '2024-07-22': {
        blocks: [
            {id: 1, x: 0, y: 0, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 2, x: 2, y: 1, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 3, x: 1, y: 3, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 4, x: 3, y: 2, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 5, x: 4, y: 4, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 6, x: 5, y: 1, width: 1, height: 2, direction: 'vertical', color: ''},
    ...
    '2024-07-23': {
        blocks: [
            {id: 1, x: 0, y: 1, width: 1, height: 2, direction: 'vertical', color: ''},
            {id: 2, x: 1, y: 1, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 3, x: 2, y: 0, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 4, x: 4, y: 1, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 5, x: 5, y: 1, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 6, x: 3, y: 3, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
    ...
    '2024-07-24': {
        blocks: [
            {id: 1, x: 1, y: 0, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 2, x: 2, y: 2, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 3, x: 4, y: 1, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 4, x: 0, y: 4, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 5, x: 3, y: 4, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 6, x: 5, y: 3, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
    ...
    '2024-07-25': {
        blocks: [
            {id: 1, x: 0, y: 0, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 2, x: 4, y: 1, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 3, x: 1, y: 1, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 4, x: 5, y: 2, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 5, x: 3, y: 0, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 6, x: 2, y: 4, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
    ...
    '2024-07-26': {
        blocks: [
            {id: 1, x: 0, y: 2, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 2, x: 1, y: 3, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 3, x: 2, y: 3, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 4, x: 4, y: 1, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 5, x: 5, y: 0, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 6, x: 5, y: 3, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 7, x: 0, y: 0, width: 2, height: 1, direction: 'horizontal', color: 'green'},
    ...
    '2024-07-27': {
        blocks: [
            {id: 1, x: 2, y: 1, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 2, x: 2, y: 3, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 3, x: 4, y: 1, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 4, x: 5, y: 0, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 5, x: 3, y: 1, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 6, x: 5, y: 4, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
    ...
    '2024-07-28': {
        blocks: [
            {id: 1, x: 1, y: 1, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 2, x: 4, y: 0, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 3, x: 5, y: 0, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 4, x: 2, y: 3, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 5, x: 3, y: 4, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
    ...
    '2024-07-29': {
        blocks: [
            {id: 1, x: 0, y: 0, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 2, x: 2, y: 2, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 3, x: 4, y: 1, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 4, x: 3, y: 4, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 5, x: 5, y: 1, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
    ...
    '2024-07-30': {
        blocks: [
            {id: 1, x: 0, y: 0, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 2, x: 1, y: 0, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 3, x: 2, y: 2, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 4, x: 5, y: 1, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 5, x: 3, y: 4, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
    ...
    '2024-07-31': {
        blocks: [
            {id: 1, x: 2, y: 0, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 2, x: 4, y: 1, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 3, x: 5, y: 1, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 4, x: 2, y: 3, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 5, x: 1, y: 3, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 6, x: 5, y: 3, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
    ...
    '2024-08-01': {
        blocks: [
            {id: 1, x: 0, y: 0, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 2, x: 0, y: 4, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 3, x: 2, y: 3, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 4, x: 3, y: 1, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 5, x: 5, y: 1, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 6, x: 5, y: 4, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
    ...
    '2024-08-02': {
        blocks: [
            {id: 1, x: 1, y: 0, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 2, x: 3, y: 4, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 3, x: 0, y: 3, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 4, x: 5, y: 2, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 5, x: 4, y: 0, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 6, x: 2, y: 2, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
    ...
    '2024-08-03': {
        blocks: [
            {id: 1, x: 0, y: 2, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 2, x: 0, y: 4, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 3, x: 1, y: 3, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 4, x: 3, y: 1, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 5, x: 5, y: 2, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 6, x: 3, y: 4, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
    ...
    '2024-08-04': {
        blocks: [
            {id: 1, x: 0, y: 3, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 2, x: 1, y: 0, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 3, x: 3, y: 1, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 4, x: 4, y: 2, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 5, x: 2, y: 4, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 6, x: 5, y: 3, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
    ...
    '2024-08-05': {
        blocks: [
            {id: 1, x: 0, y: 3, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 2, x: 1, y: 0, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 3, x: 3, y: 4, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 4, x: 4, y: 2, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 5, x: 5, y: 1, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 6, x: 4, y: 0, width: 2, height: 1, direction: 'horizontal', color: 'green'},
    ...
    '2024-08-06': {
        blocks: [
            {id: 1, x: 0, y: 1, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 2, x: 0, y: 3, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 3, x: 1, y: 1, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 4, x: 2, y: 3, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 5, x: 3, y: 4, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 6, x: 4, y: 0, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 7, x: 5, y: 2, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
    ...
    '2024-08-07': {
        blocks: [
            {id: 1, x: 0, y: 0, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 2, x: 2, y: 1, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 3, x: 3, y: 2, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 4, x: 4, y: 1, width: 1, height: 3, direction: 'vertical', color: 'darkred'},
            {id: 5, x: 5, y: 3, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 6, x: 1, y: 4, width: 1, height: 2, direction: 'vertical', color: 'darkred'},
            {id: 7, x: 2, y: 0, width: 2, height: 1, direction: 'horizontal', color: 'green'},
